            ...
            <table class="secondsection" width="100%">
                <tr>
                    <td>
                        ...
                        <p>
                            Asegúrate de conocer todo sobre el proyecto y las noticias uniéndote a nuestro <strong>Discord</strong> y siguiendo nuestras redes sociales.
                        </p>
                        <p>
                            Encontrarás una comunidad agradable y amigable.  Tendremos concursos y premios en <strong>NFTs</strong> que podrás usar en <strong/>Secret Forest.</strong>
                        </p>
                        <p>¡Saludos!
                        </p>
            ...
            <table class="footer" style="margin: auto;">
                <tr>
                    <td>
                        ...
                        <p>
                            Está recibiendo este correo electrónico porque se registró en uno de nuestros eventos en persona o se suscribió a las actualizaciones beta en https://secretforestworld.net/<br />
